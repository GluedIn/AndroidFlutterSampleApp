package com.gluedin.sample.shopify
...
import com.gluedin.sample.gluedin_quick_launch_sample.R
import com.gluedin.sample.gluedin_quick_launch_sample.databinding.ActivityWebViewBinding
...
class WebViewActivity : AppCompatActivity() {
    ...
    fun Context.updateStatusBar(@ColorInt backgroundColor: Int? = null) {
        (this as AppCompatActivity).apply {
            val resolvedColor = backgroundColor ?: ContextCompat.getColor(this, R.color.black)
